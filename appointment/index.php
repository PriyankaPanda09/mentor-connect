...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">Mentor Connect </font>
            ...
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">How much knowledge you gained today, Sounds like not good!<br>Don't worry. Find your mentor online !!Book as you wish with mentor connect. <br>
                    We offer you a free mentor channeling service, Make your appointment now.</p>
                </td>
            </tr>
            <tr>
        ...
        <p class="sub-text2 footer-hashen">A Web Solution by Mentor Connect.</p>
    </center>
